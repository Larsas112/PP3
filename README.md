...
<details>
    ...
    <code>
         ...
         <?xml version="1.0" encoding="UTF-8"?>
         <svg xmlns="http://www.w3.org/2000/svg" version="1.1" width="800mm" height="600mm" viewBox="-400 -300 800 600">
       <title>SVG Shapes</title>
       <desc>A SVG with 3 general structures</desc>
       <rect x="10" y="10" width="50" height="50" fill="blue" />
       <line x="65" y="10" width="10" heigth="400" fill="yellow" />
       <circle x="80" y="10" width="50" height="50" fill="green" />
     </svg>  
    </code>
</details>
...
Mithilfe des <code>#</code> lassesn sich Überschriften festlegen. Für untergeordnete Überschriften werden weiter Hashtags hinzugefügt.
</details>
<details>
    <summary>How do you mark italic or bold font?</summary>
    <code>

Um die Schrift in *Kursiv* oder **Fett** zu ändern, wird das Stern-Symbol verwendet. Der Text wird für Kursiv mit einem und für Fett mit zwei Stern-Symbolen (asterisk) umschlossen.
...
Listen können einerseits als solche aufgeschrieben werden, wenn sie mit 1 starten und darauf ein Punkt folgt werden auch die weiteren zeilen mit "Zahl". als wéitere einträge interpretiert. mithilfe eines Tabs oder Leerzeichen davor ist es möglich untergeornete Listen zu erstellen.
Gleichermaßen können auch * + oder - verwendet werden.
...
Bei der Audführung wurden folgende Dateien erstellt:
example.log
example.aux
example.pdf
</details>
...
Um den namen einer Datei zu ändern kann der befehle mv benutzt werden. <code> mv example.pdf main.pdf</code>
</details>
...
Es wird eine einzelne Titelseite erzeugt. Der Inhalt (Text) beginbt damit erstauf seite 2. Die Seitenzahl wird nun ab der zweiten Seite oben links dargestellt.
</details>
<details>
